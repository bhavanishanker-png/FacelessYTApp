...
import { PlaySquare, Mail, Lock, User, ArrowRight, Loader2, Eye, EyeOff, Sparkles } from "lucide-react";
    ...
    <div className="min-h-screen w-full flex bg-[#030303] font-sans">
      ...
      <div className="hidden lg:flex lg:w-[55%] relative overflow-hidden flex-col justify-between p-12 xl:p-16">
        ...
        <div className="flex-1 flex flex-col justify-center -mt-10">
          ...
          >
            {["AI Scripts", "Voice Synthesis", "Auto Scenes", "One-Click Export"].map((tag) => (
              <span
                key={tag}
        ...
        >
          ...
          <div className="mb-10">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-emerald-400/70">Get Started</span>
            </div>
            <h2 className="text-3xl font-extrabold text-white tracking-tight mb-2">
              Create your account
            </h2>
            <p className="text-white/30 text-[15px] font-medium">
              Start building faceless YouTube videos in minutes.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {/* Name */}
            <div>
              <label htmlFor="signup-name" className="flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.15em] text-white/25 mb-2.5">
            ...
            {/* Email */}
            <div>
              <label htmlFor="signup-email" className="flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.15em] text-white/25 mb-2.5">
            ...
            {/* Password */}
            <div>
              <label htmlFor="signup-password" className="flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.15em] text-white/25 mb-2.5">
              ...
              <p className="mt-2 text-[11px] text-white/15 font-medium">Must be at least 6 characters</p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="flex items-center justify-center gap-2.5 py-3 rounded-xl bg-white/[0.03] border border-white/[0.06] hover:bg-white/[0.05] hover:border-white/[0.1] transition-all duration-200"
              >
                ...
                <span className="text-[12px] font-semibold text-white/50">Google</span>
              </motion.button>
              ...
              >
                ...
                <span className="text-[12px] font-semibold text-white/50">GitHub</span>
              </motion.button>
            </div>
          </form>
