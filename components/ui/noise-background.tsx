...
export const NoiseBackground = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "group relative overflow-hidden rounded-2xl bg-neutral-800 p-2 backdrop-blur-sm",
        "shadow-[0px_1px_0px_0px_rgba(10,10,10,1)_inset,0px_1px_0px_0px_rgba(38,38,38,1)]",
        backdropBlur &&
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <img
          ...
          style={{ mixBlendMode: "overlay", opacity: "var(--noise-opacity)" }}
        />
      </div>
